...
# see config.json
#
# F.Thiebolt    dec.20  initial release
#
...
wlan.connect(ssid='neOCampus', auth=(WLAN.WPA2, "XXXXXXXX"))
...
rtc = RTC()
rtc.ntp_sync(server="ntp.univ-tlse3.fr")
...
# Start the Pygate
print("Starting PyGate packet forwarding ...")
time.sleep(0.5)
machine.pygate_init(buf)

# to disable degub messages
# machine.pygate_debug_level(1)
machine.pygate_debug_level(5)
